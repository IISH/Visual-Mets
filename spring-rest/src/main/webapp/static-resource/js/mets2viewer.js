(function($){
     ...
     * @option template     String          the html to load if this is not ste it will look in to the dom (target) for the html
     ...
     * @option layout       String          the name reverence of the layout that must by the onload
     * @option layoutConfig Object          ist possible to overwrite event layout loading behaviour's
     * @option layoutConfig.*
     * @see Controller.LayoutManager, file mets2.layout.manager.js, line 45
     *
     * ----------------------------------------------------------------------------------------------------
     * for all the extend methods, this must be load before all other extend methods
     * example:
     * ....................................................................................................
     *
     ...
     viewer.init({
        'url'      : 'http://node-143.dev.socialhistoryservices.org/mets2/rest/document?',
    ...
    $.fn.extend({
        ...
        mets2Viewer: function(options) {
            ...
            // initialize options
            options.initialize.url      = options.initialize.url || 'http://node-143.dev.socialhistoryservices.org/mets2/rest/document?';
    ...
    /**
     * the rout method for binding  event functionality
     * @param arg1
     * @param arg2
     */
     ...
     * can add his own mets2Viewer arguments whit default behaviour's
     *
     * the param is is array white objects see sample below.
     * define whit the key the Model[field] and the valie (String) the options target
    ...
    /**
     * interface functionality this is written to help by development the necessary field and methods
     * correctly implemented
     * @param reverence the object reverence iets object must return methods
    ...
    /**
     * the auto binding method vor the inner property "events"
     * it will automatic bind the events to the button on name reverence
     ...
     * in de property "methods" we decelerate the methods that can be used in de event function "click.1, click.2"
     *
     ...
     *
     * in this library there is the convention that a method that returns methods, what is written to simulate a class behaviour
     * must be written whit first character uppercase
     *
     */
                ...
                for(var btnName in buttons){
                    if(buttons.hasOwnProperty(btnName)){
                        ...
                        if(btnName == eventName){
                            ...
                            // ad add the methods divination's to it
                                ...
                                if(obj.events.hasOwnProperty(type)){
                                    ...
                                    (function(btn, obj, type, contrl){
                                        btn.on(type+'.mets2', function(){
                                            ...
                                            // add the controller object reverence
