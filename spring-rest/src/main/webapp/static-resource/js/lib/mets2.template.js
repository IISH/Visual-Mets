(function($){
    ...
    /**
     * load the template, if the url is empty than look in the dom for the template
     * if the template is already loaded than load it from the global storage point
    ...
    App.mets2.Controller.extend('loadTemplate', function(){
        ...
        // if the url is empty do not get template but look in the dom
