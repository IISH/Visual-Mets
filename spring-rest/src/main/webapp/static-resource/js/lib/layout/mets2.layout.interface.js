 ...
 * methods for a compatible layout for the metsviewer
 * @constructor
 */
App.mets2.LayoutInterface = function(){
    ...
    /**
     * return the model settings of the template
     * @return {{Object:*}}
     */
    ...
    /**
     * return the parameters for scaling the image
    ...
    /**
     * map the url type to the data reference in the view.Page object
     * @see view.Page
     * @see view.Page.data
   ...
   /**
    * return events defined in the field "events"
    * @notice a onclick event must return a layout type (string) "PageLayout"
    * so that the controller nows which layout to load
    ...
    */
     ...
     * the layout has functionality dat must be re-renderd like for example html wrapping cells
     * for images
     */
     ...
     * In this example we turn of the "transcription" button and we leave "fullscreen" button visible
     */
