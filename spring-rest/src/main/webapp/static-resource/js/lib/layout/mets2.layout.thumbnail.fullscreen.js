(function($){
    ...
    App.mets2.View.extend('ThumbnailFullScreenLayout', function(){
        ...
        var methods = {
             ...
             * @notice an onclick event must return a layout type (string) "PageLayout"
            ...
            /**
             * this method returns the size of the grid from the thumbnails
            ...
            /**
             * re-render the width and the height if there is a change in the frame and canvas
             * @return void
             */
            update : function(){
            ...
            /**
             * return html for wrapping the image for design purposes
             * @returns {*|jQuery}
             */
            getImageWrapper : function(){
                var size = methods.getGridSize();
