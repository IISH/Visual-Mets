(function($){
    ...
    /**
     * set the canvas reference jquery selector
     * @see Controller.init
     * @return void
     */
    ...
    /**
     * Canvas is the functionality for the canvas view where the page , messages, loader etc. is shown
     * returns methods
     * @return {{
          getCanvas                 : function,
          getSize                   : function,
    ...
    App.mets2.View.extend('Canvas', function(){
        ...
        return {
            ...
            /**
             * almost the same as getSize  method but this one returns the width and height
             * including the with aspect of zooming level and steps for returning zooming
             * sizes
             * @returns {{height: *, width: *}}
             */
