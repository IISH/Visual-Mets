(function($){
     ...
     * @field fullScreen.active    boolean   store setting if full screen is activated it will be "true", default "false"
     */
    ...
    App.mets2.Controller.extend('deactivateFullScreen', function(){
        ...
        frame.release();
        frame.setSize({
            width   : frame.getParentSelector().width(),
            height  : frame.getParentSelector().height()
        });
        frame.render();
