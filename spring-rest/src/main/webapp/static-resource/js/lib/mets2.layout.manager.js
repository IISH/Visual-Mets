(function($){
     ...
     * 4 tiles view layout
     *
     * buttons will be shown or hidden on configuration
     * the page layout must have as option which page to load, now it's hard coded
     * if not set then by default page 1 index 0
     *
     * load layout interpreter with the layout behaviours
     */
    ...
    /**
     * map the option parameter to the reference point layout.name
     *
     * for the default size and full screen size its possible to define your own template
     * to load by those behaviours in the instance configuration
     * sample:
     * ----------------------------------------------------------------------------------
       layoutConfig : {
                toFullScreen : {
     ...
     * ..................................................................................
     * in full screen mode you see that the "ThumbnailLayout" the "ThumbnailFullScreenLayout" will load on full screen
     * and going from full screen to default we see that the "ThumbnailFullScreenLayout" the "ThumbnailLayout" will load
     *
     ...
     * -----------------------------------------------------------------------------------
     *
     * the key "fullScreen" and "defaultScreen" describes the current behaviour position
     * and below you see the layout that currently is loaded and if start is executed
    ...
    /**
     * get the properties of full screen loading layouts
     * @return {Object|*}
     */
    ...
    /**
     * get the properties of default screen loading layouts
     * @return {Object|*}
     */
    ...
    /**
     * get the properties of default start screen layouts
     * @return {Object|*}
     */
    ...
    /**
     * setter to store the current active layout
     * @param {{Layout: Object}}
     * @return void
     */
     ...
     * and interpret the layout behaviours and settings
     *
     * returns methods
     * @return {{
...
App.mets2.Controller.extend('LayoutManager', function(){
    ...
    var _ = {
        ...
        parseViesOfLayouts : function(views){
            ...
            var wrapperClass = '.mets-button-wrapper';
        ...
        /**
        * set the proper style layout reference
        */
    ...
    var methods = {
        /**
         * load all the pages in query for events:
         ...
         */
        pageQueueLoader : function(Pages, pos, end, errorCount){
            ...
            if(page){
                ...
                controller.event.fire('onImageLoad', page, pos, end);
                ...
                page.load(function(){
                    ...
                    if(pos < end){
                        ...
                        if(pos == end){
                            ...
                            self.pageQueueLoader(Pages, pos, end, errorCount);
                        }
                    }else{
        ...
        /**
         * set the layout Object by type name eg thumbnail => ThumbnailLayout
         * @param type String
        ...
        /**
         * get the layout Object by type name eg thumbnail => ThumbnailLayout
        ...
        /**
         * get the amount of loaded pages check if not created, then create
         * @return {{LayoutManager: Object}}
         */
        setPages : function(){
        ...
        /**
         * if the id of a page exist or page id exist
         * @param id
         * @returns {boolean}
         */
        ...
        /**
         * get the first page from the model
         * @see Model.getLayoutPages
         * @see Model.layout.pages
         * @returns {*}
         */
        ...
        init : function(){
            ...
            // parse views given by the currently loaded layout
