(function($){
    ...
    /**
     * add button reference to the model, store the arguments in the model
    ...
    App.mets2.Controller.extend('init', function(param){
        ...
        this.event.addListener('templateReady', function(){
            ...
            // create breadcrumb on status request 200 ...
            ...
            // triggers when the que is started
