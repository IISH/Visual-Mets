(function($){
     ...
     * there this method will be created as a new instance that's why
    ...
    App.mets2.View.extend('Page', function(_view, _data){
        ...
        /**
         * set the url in the img dom object reference "img.mets-page"
        ...
        this.add = function(parent){
            ...
            if(this.model.getCanvasSelector().find('img#'+this.id).length == 0){
                ...
                // if there is html wrapped around the page...
        ...
        /**
         * get the parameters in url string format
         * @return param String
         */
        ...
        /**
         * function will be triggered if the image is loaded in the dom
         * @param fn
         * @return {{Page: Object}}
         */
        ...
        /**
         * function will be triggered if the image can't be loaded
         * @param fn callback
         * @return {{Page: Object}}
         */
