(function ($) {
     ...
     *
     ...
     viewer.init({
        'url'      : 'hhttp://localhost:8282/rest/document?',
     ...
     *
     $('#metsViewSample').mets2Viewer({
        ...
        layout : 'thumbnail',
        initialize : {
            'url'      : 'http://localhost:8282/rest/document?',
            'metsId'   : $('input[name=metsId]').val(),
            'defaults' : true,
            'pager' : {
                'start' : 0,
    ...
    $.fn.extend({
        ...
        mets2Viewer: function (options) {
            ...
            // initialize options
            options.initialize.url = options.initialize.url || 'http://localhost:8282/rest/document?';
