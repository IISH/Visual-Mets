(function($){
    ...
    App.mets2.Model.extend({
        share : {
            link : {
                css : 'http://visualmets.socialhistory.org/rest/resources/css/themes/default/style.css',
                js : 'http://visualmets.socialhistory.org/rest/resources/js/mets2viewer.min.js'
            },
            modal : {
                header : 'Embed code',
