(function($){
    ...
    /**
     * work around for prototype bug
     * TODO must fix this prototype object reverence bug
    ...
    /**
     * the important solution for changing layout and pagination steps
     * @return void
     */
    App.mets2.Controller.extend('paginationPositionManager', function(){
        ...
        // notice only use this if a layout (amount of pages (steps)) bigger is than 1
        if(steps > 1){
